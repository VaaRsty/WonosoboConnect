...
<head>
    ...
    <title>Tentang Kami - Wonosobo Connect</title>
</head>
<body>
    <header>
        <div class="logo">
    ...
    <main>
        <section id="about">
            <h2>Tentang Kami</h2>
            <p>Wonosobo Connect adalah platform digital yang menyediakan berbagai layanan publik secara terpadu untuk masyarakat Kabupaten Wonosobo.</p>
        </section>
    </main>
